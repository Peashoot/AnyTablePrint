    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < columncount; i++)
                dgv_PreviewTable.Columns.Add(new DataGridViewTextBoxColumn() { AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill });
        ...
        {
            dgv_PreviewTable.Columns.Insert(CellLocation.Y, new DataGridViewTextBoxColumn() { AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill });
            CombineList.ForEach(a =>
            {
